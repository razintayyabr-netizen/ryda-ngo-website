  ...
  return (
    <section className="section programs-section" id="programs">
      ...
      <div className="programs-grid">
          <article className="prog-card reveal" style={{ '--delay': '0s' }} aria-label="Human Rights Documentation & Reporting">
          ...
          <article className="prog-card reveal" style={{ '--delay': '0.06s' }} aria-label="Advocacy & International Engagement">
          ...
          <article className="prog-card reveal" style={{ '--delay': '0.12s' }} aria-label="Youth Leadership & Capacity Building">
          ...
          <article className="prog-card reveal" style={{ '--delay': '0.18s' }} aria-label="Research & Analysis">
          ...
          <article className="prog-card reveal" style={{ '--delay': '0.24s' }} aria-label="Community Engagement & Participation">
          ...
          <article className="prog-card reveal" style={{ '--delay': '0.30s' }} aria-label="Campaigns & Awareness Raising">
          ...
          <article className="prog-card reveal" style={{ '--delay': '0.36s' }} aria-label="Accountability & Justice Initiatives">
          ...
          <article className="prog-card reveal" style={{ '--delay': '0.42s' }} aria-label="Education & Literacy Development">
          ...
          <article className="prog-card reveal" style={{ '--delay': '0.48s' }} aria-label="Humanitarian Assistance in Emergencies">
